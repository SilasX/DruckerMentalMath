...
function MultProbController(topSize, bottomSize) {
    ...
    this.workClick = function(jqObj) {
        var writeSelector = ".workarea span, .finalanswer span";
    ...
    this.choiceClick = function(jqObj) {
        ...
        var workSel = ".workarea span.selected"; // work area selector
        var finalSel = ".finalanswer span.selected"; // final area selector
    ...
    this.getpicsClick = function() {
        // get selected object
        var selectionObj = $(".workarea span.selected");
    ...
    this.setHandlers = function(obj) {
        $(".workarea span, .finalanswer span").click(function() {
            obj.workClick($(this));
        });

        $(".numchoices span").click(function() {
